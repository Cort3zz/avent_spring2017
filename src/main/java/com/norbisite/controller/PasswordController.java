...
public class PasswordController {
    ...
    public void addDailyMessages() {
        ...
        dailyMessageDAO.save(new DailyMessage(6, "<h2>Hatodik üzenet</h2> <p>Feltöltés alatt, nézz vissza később!! :) </p>"));
        dailyMessageDAO.save(new DailyMessage(7, "<h2>Hetedik üzenet</h2> <p>Feltöltés alatt, nézz vissza később!! :) </p>"));
        dailyMessageDAO.save(new DailyMessage(8, "<h2>Nyolcadik üzenet</h2> <p>Feltöltés alatt, nézz vissza később!! :) </p>"));
        dailyMessageDAO.save(new DailyMessage(9, "<h2>Kilencedik üzenet</h2> <p>Feltöltés alatt, nézz vissza később!! :) </p>"));
